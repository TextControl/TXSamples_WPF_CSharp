...
namespace Step2 {
	...
	public partial class MainWindow : Window {
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void Hyperlinks_DropDownOpening(object sender, RoutedEventArgs e) {
			...
			m_tmiInsertHyperlink.IsEnabled = m_hlCurrentHyperlink == null;
			// Disable the 'Edit...' item if there is no hyperlink at the
			// current input position.
			m_tmiEditHyperlink.IsEnabled = m_hlCurrentHyperlink != null;
		}
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void TextControl_TextFieldCreated(object sender, TXTextControl.TextFieldEventArgs e) {
			...
			if (e.TextField is TXTextControl.HypertextLink) {
				HighlightHyperlink(e.TextField as TXTextControl.HypertextLink, m_tmiShowHyperlinks.IsChecked);
			}
		}
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void ShowHyperlinks_Click(object sender, RoutedEventArgs e) {
			...
			foreach (TXTextControl.HypertextLink link in colHyperlinks) {
				HighlightHyperlink(link, m_tmiShowHyperlinks.IsChecked);
			}
