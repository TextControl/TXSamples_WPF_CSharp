	...
	partial class MainWindow {
	    ...
	    **-----------------------------------------------------------------------------------------------------------*/
		private void TextControl_InputPositionChanged(object sender, EventArgs e) {
			m_ctgTableTools.Visibility = m_txTextControl.Tables.GetItem() != null && m_ctgReportingResult.Visibility!= System.Windows.Visibility.Visible ? System.Windows.Visibility.Visible : System.Windows.Visibility.Collapsed;
		}
	    ...
	    **-----------------------------------------------------------------------------------------------------------*/
		private void TextControl_FrameSelected(object sender, FrameEventArgs e) {
			...
			m_ctgFrameTools.Visibility = m_ctgReportingResult.Visibility!= System.Windows.Visibility.Visible? System.Windows.Visibility.Visible : System.Windows.Visibility.Collapsed;
		}
