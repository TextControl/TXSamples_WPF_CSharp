	...
	partial class MainWindow {
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void SetSidebarBehavior() {
			...
			m_dpdSidebarContentLayout.AddValueChanged(m_sbSidebarLeft, SidebarLeft_ContentLayoutChanged);
        ...
        ** Toggles the document settings button if the left sidebar is shown and its ContentLayout is set to 
        ** DocumentSettings. Otherwise the button is untoggled.
        **-----------------------------------------------------------------------------------------------------------*/
		private void SidebarLeft_IsShownChanged(object sender, EventArgs e) {
			m_rtbtnDocumentSettings.IsChecked = m_sbSidebarLeft.ContentLayout == Sidebar.SidebarContentLayout.DocumentSettings && m_sbSidebarLeft.IsShown;
