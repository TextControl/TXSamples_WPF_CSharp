        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private bool SaveDirtyDocumentOnOpen() {
			...
			if (m_bIsDirtyDocument) {
				...
				// Show message box.
				MessageBoxResult mbrSaveFile = MessageBox.Show(this, strMessageBoxTExt, Properties.Resources.MessageBox_SaveDirtyDocumentOnOpen_Caption, MessageBoxButton.YesNoCancel, MessageBoxImage.Warning);
