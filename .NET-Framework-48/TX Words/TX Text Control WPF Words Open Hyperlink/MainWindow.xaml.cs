	...
	public partial class MainWindow : RibbonWindow {
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		public MainWindow() {
			...
			// Set Open Hyperlink settings
			SetOpenHyperlinkBehavior();

			// Load the sample document if no other document is referenced by command line args
			string[] rstrArgs = Environment.GetCommandLineArgs();
			if (rstrArgs.Length <= 1) {
				m_txTextControl.Loaded += TextControl_Loaded_Sample;
			}
		}
        ...
        **-----------------------------------------------------------------------------------------------------*/
		...
		/*-------------------------------------------------------------------------------------------------------
        ** TextControl_Loaded_Sample Handler 
        ** Load the sample document.
        **-----------------------------------------------------------------------------------------------------*/
		private void TextControl_Loaded_Sample(object sender, RoutedEventArgs e) {
