	...
	public partial class MainWindow : RibbonWindow {
        ...
        **-----------------------------------------------------------------------------------------------------*/
		private void SetAppMenuDesign() {
			...
			SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_SignIn.ToString(), m_rmiSignIn, m_strUserName);
			SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_CurrentUser.ToString(), m_rmbtnCurrentUser, m_strUserName);
			SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_AccountSettings.ToString(), m_rmiAccountSettings, m_strUserName);
			SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_SignOut.ToString(), m_rmiSignOut, m_strUserName);
        ...
        **-----------------------------------------------------------------------------------------------------*/
		private void SetAppMenuBehavior() {
			...
			// Sign In:
			m_rmiSignIn.Click += SignIn_Click;

			// [Current User]:
			m_rmiAccountSettings.Click += AccountSettings_Click; // Account Settings (Drop Down Button)
			m_rmiSignOut.Click += SignOut_Click; // Sign Out (Drop Down Button)
		}
        ...
        ** Load the sample document and sets the focus to the TextControl.
        **-----------------------------------------------------------------------------------------------------*/
