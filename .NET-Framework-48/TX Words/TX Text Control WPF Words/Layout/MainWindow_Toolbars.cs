	...
	partial class MainWindow {
        ...
        **-----------------------------------------------------------------------------------------------------------*/
        private void SetButtonBar() {
            // ButtonBar 
            m_bbButtonBar.Background = new SolidColorBrush(Color.FromArgb(255, 245, 246, 247));
        }
        ...
        **-----------------------------------------------------------------------------------------------------------*/
        private void SetStatusBarDesign() {
            ...
            m_sbStatusBar.DisplayColors.ForeColor = Colors.White;
            m_sbStatusBar.DisplayColors.SeparatorColorDark = Colors.White;
        }
    }
}
