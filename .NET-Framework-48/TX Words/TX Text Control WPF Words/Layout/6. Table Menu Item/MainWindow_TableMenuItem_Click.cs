...
namespace TXTextControl.Words {
	partial class MainWindow {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Insert_Table_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Insert_ColumnToTheLeft_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Insert_ColumnToTheRight_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Insert_RowAbove_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Insert_RowBelow_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Delete_Cells_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Delete_Columns_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Delete_Rows_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Delete_Table_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Select_Cell_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Select_Column_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Select_Row_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Select_Table_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
			tblTable.Select();
		}
		...
		** Item: 'Merge Cells'
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_MergeCells_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
			tblTable.MergeCells();
		}
		...
		** Item: 'Split Cells'
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_SplitCells_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
			tblTable.SplitCells();
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_SplitTable_Above_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_SplitTable_Below_Click(object sender, RoutedEventArgs e) {
			Table tblTable = m_txTextControl.Tables.GetItem();
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Formulas_A1ReferenceStyle_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Formulas_R1C1ReferenceStyle_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Formulas_EditFormula_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Formulas_AutomaticCalculation_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.IsFormulaCalculationEnabled = m_miTable_Formulas_AutomaticCalculation.IsChecked;
		}
		...
		** Item: 'Properties...'
		**-----------------------------------------------------------------------------------------------------------*/
		private void Table_Properties_Click(object sender, RoutedEventArgs e) {
