        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private bool SaveDirtyDocumentOnExit() {
			...
			if (m_bIsDirtyDocument) {
				...
				MessageBoxResult mbrDialogResult = MessageBox.Show(this, strMessageBoxTExt, Properties.Resources.MessageBox_SaveDirtyDocumentOnExit_Caption, MessageBoxButton.YesNoCancel, MessageBoxImage.Warning);
				switch (mbrDialogResult) {
