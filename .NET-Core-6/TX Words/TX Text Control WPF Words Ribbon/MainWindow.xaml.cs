	...
	public partial class MainWindow : RibbonWindow {
        ...
        **-----------------------------------------------------------------------------------------------------*/
		private void SetAppMenuDesign() {
			...
			SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_DocumentSettings.ToString(), m_rtbtnDocumentSettings);
			...
			SetMenuItemDesign(ResourceProvider.FileMenuItem.TXITEM_Exit.ToString(), m_rmiExit);
