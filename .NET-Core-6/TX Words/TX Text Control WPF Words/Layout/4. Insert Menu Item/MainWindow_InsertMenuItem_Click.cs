...
using TXTextControl.WPF.Barcode;
	...
	partial class MainWindow {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Image_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.Images.Add(new Image(), TXTextControl.HorizontalAlignment.Left, -1, ImageInsertionMode.DisplaceText);
		}
		...
		** Item: 'Text Frame'
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_TextFrame_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.TextFrames.Add(new TextFrame(new System.Drawing.Size(2880, 2880)), TextFrameInsertionMode.DisplaceText | TextFrameInsertionMode.MoveWithText);
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Shape_ShapeCategory_MenuItem_Click(object sender, RoutedEventArgs e) {
			AddShape((Drawing.ShapeType)(e.Source as MenuItem).Tag);
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Shape_DrawingCanvas_Click(object sender, RoutedEventArgs e) {
			...
			m_txTextControl.Drawings.Add(dfDrawingFrame, TXTextControl.HorizontalAlignment.Left, -1, FrameInsertionMode.DisplaceText);
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Barcode_MenuItem_Click(object sender, RoutedEventArgs e) {
			TXBarcodeControl txbBarcodeControl = new TXBarcodeControl {
				Width = 240,
				Height = 180,
				BarcodeType = (Barcode.BarcodeType)(e.Source as MenuItem).Tag
			};
			BarcodeFrame bfBarcodeFrame = new BarcodeFrame(txbBarcodeControl);
			m_txTextControl.Barcodes.Add(bfBarcodeFrame, TXTextControl.HorizontalAlignment.Left, -1, FrameInsertionMode.DisplaceText | FrameInsertionMode.MoveWithText);
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Header_Insert_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Header_Remove_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Footer_Insert_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Footer_Remove_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_PageNumber_Insert_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_PageNumber_Remove_Click(object sender, RoutedEventArgs e) {
			HeaderFooter hfHeaderFooter = m_txTextControl.TextParts.GetItem() as HeaderFooter;
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_FormFields_TextFormField_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_FormFields_CheckBox_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_FormFields_ComboBox_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_FormFields_DropDownList_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_FormFields_DateFormField_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_FormFields_Delete_Click(object sender, RoutedEventArgs e) {
		...
		** Item: 'Symbol...'
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Symbol_Click(object sender, RoutedEventArgs e) {
		...
		** Item: 'Hyperlink...'
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Hyperlink_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Bookmark_Insert_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Bookmark_Delete_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_TableOfContents_Insert_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_TableOfContents_Delete_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_TableOfContents_Update_Click(object sender, RoutedEventArgs e) {
			TableOfContents tocTableOfContens = m_txTextControl.TablesOfContents.GetItem();
			if (tocTableOfContens != null) {
				if (tocTableOfContens.Update() == TableOfContentsCollection.AddResult.ContentNotFound) {
					MessageBox.Show(this, Properties.Resources.MessageBox_UpdateTableOfContents_NoContents_Text, Properties.Resources.MessageBox_UpdateTableOfContents_NoContents_Caption, MessageBoxButton.OK, MessageBoxImage.Information);
				}
			}
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Columns_One_Click(object sender, RoutedEventArgs e) {
			SetColumnCount(1);
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Columns_Two_Click(object sender, RoutedEventArgs e) {
			SetColumnCount(2);
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_Columns_MoreColumns_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_PageBreaks_Page_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_PageBreaks_Column_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_PageBreaks_TextWrapping_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_SectionBreaks_NextPage_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Insert_SectionBreaks_Continuous_Click(object sender, RoutedEventArgs e) {
