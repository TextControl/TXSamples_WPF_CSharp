...
namespace TXTextControl.Words {
	partial class MainWindow {
		...
		** Item: 'Find...'
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_Find_Click(object sender, RoutedEventArgs e) {
		...
		** Item: 'Replace...'
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_Replace_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_Permissions_AllowFormatting_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.DocumentPermissions.AllowFormatting = m_miEdit_Permissions_AllowFormatting.IsChecked;
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_Permissions_AllowFormattingStyles_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.DocumentPermissions.AllowFormattingStyles = m_miEdit_Permissions_AllowFormattingStyles.IsChecked;
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_Permissions_AllowPrinting_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.DocumentPermissions.AllowPrinting = m_miEdit_Permissions_AllowPrinting.IsChecked;
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_Permissions_AllowCopy_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.DocumentPermissions.AllowCopy = m_miEdit_Permissions_AllowCopy.IsChecked;
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_Permissions_AllowEditingFormFields_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.DocumentPermissions.AllowEditingFormFields = m_miEdit_Permissions_AllowEditingFormFields.IsChecked;
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_Permissions_ReadOnly_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.DocumentPermissions.ReadOnly = m_miEdit_Permissions_ReadOnly.IsChecked;
		}
		...
		**		 drop down menu)
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_EditableRegions_Add_ForCurrentUser_Click(object sender, RoutedEventArgs e) {
		...
		**		 drop down menu)
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_EditableRegions_Add_ForEveryone_Click(object sender, RoutedEventArgs e) {
		...
		**		 drop down menu)
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_EditableRegions_Remove_ForCurrentUser_Click(object sender, RoutedEventArgs e) {
		...
		**		 drop down menu)
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_EditableRegions_Remove_ForEveryone_Click(object sender, RoutedEventArgs e) {
			RemoveUser("");
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_ProtectDocument_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.EditMode = m_miEdit_ProtectDocument.IsChecked ? EditMode.ReadAndSelect | EditMode.UsePassword : EditMode.Edit;
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_TrackedChanges_TrackChanges_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.IsTrackChangesEnabled = m_miEdit_TrackedChanges_TrackChanges.IsChecked;
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_TrackedChanges_ReviewTrackedChanges_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_Comments_AddComment_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Edit_Comments_ReviewComments_Click(object sender, RoutedEventArgs e) {
