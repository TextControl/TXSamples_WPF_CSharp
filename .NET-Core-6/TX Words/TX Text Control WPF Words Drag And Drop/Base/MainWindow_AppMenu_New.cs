        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private bool SaveDirtyDocumentOnNew() {
			...
			if (m_bIsDirtyDocument) {
				...
				// Show message box.
				MessageBoxResult mbrSaveFile = MessageBox.Show(this, strMessageBoxText, Properties.Resources.MessageBox_SaveDirtyDocumentOnNew_Caption, MessageBoxButton.YesNoCancel, MessageBoxImage.Warning);
				switch (mbrSaveFile) {
