...
namespace TXTextControl.Words {
	partial class MainWindow {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		...
		private MergeSettingsDialog m_dlgMergeSettingsDialog;
		private ExportMergeResultDialog m_dlgExportMergeResult;
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void SampleInvoiceTemplate_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void SamplePackingListTemplate_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void SampleShippingLabelTemplate_Click(object sender, RoutedEventArgs e) {
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void MergeAndExport_Click(object sender, RoutedEventArgs e) {
			// Open an instance of the merge settings dialog. 
			m_dlgMergeSettingsDialog = new MergeSettingsDialog();
			if (m_dlgMergeSettingsDialog.ShowDialog().Value) {
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void ExitResultTab_Click(object sender, RoutedEventArgs e) {
			m_rbnRibbon.SelectedItem = m_rtLastSelectedTab;
			CloseResultTab();
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void Reporting_RibbonTabIndexChanged(object sender, SelectionChangedEventArgs e) {
			if (m_ctgReportingResult.Visibility == Visibility.Visible && m_rbnRibbon.SelectedItem != m_rtMergeResultsTab) {
				CloseResultTab();
			}
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void ExportMergeResult_Click(object sender, RoutedEventArgs e) {
			...
			if (m_dlgExportMergeResult.ShowDialog().Value) {
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void SetResultTabBehavior() {
			m_rbnRibbon.SelectionChanged += Reporting_RibbonTabIndexChanged;
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void ShowResultTab(IList<byte[]> mergedFiles) {
			...
			m_rtLastSelectedTab = m_rbnRibbon.SelectedItem as RibbonTab;
			...
			m_ctgReportingResult.Visibility = Visibility.Visible;
			// Ensure that the "Table" contextual tab is hidden.
			m_ctgTableTools.Visibility = Visibility.Collapsed;
			// Show the 'Result' Tab.
			m_rbnRibbon.SelectedItem = m_rtMergeResultsTab;
		}
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void CloseResultTab() {
			...
			m_ctgReportingResult.Visibility = Visibility.Collapsed;
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void LoadMergeFile(int index) {
			...
			m_rbtnFirstRecord.IsEnabled =
			m_rbtnPreviousRecord.IsEnabled = m_iCurrentMergedFile > 0;
			m_rbtnNextRecord.IsEnabled =
			m_rbtnLastRecord.IsEnabled = m_iCurrentMergedFile < m_lstMergedFiles.Count - 1;
			...
			m_rbtnFirstRecord.ToolTipDescription = string.Format(strToolTipDescription, 1);
			m_rbtnPreviousRecord.ToolTipDescription = string.Format(strToolTipDescription, m_iCurrentMergedFile);
			m_rbtnNextRecord.ToolTipDescription = string.Format(strToolTipDescription, m_iCurrentMergedFile + 2);
			m_rbtnLastRecord.ToolTipDescription = string.Format(strToolTipDescription, m_lstMergedFiles.Count);
		}
