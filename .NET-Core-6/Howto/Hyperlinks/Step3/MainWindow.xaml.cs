...
namespace Step3 {
	...
	public partial class MainWindow : Window {
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void Links_DropDownOpening(object sender, RoutedEventArgs e) {
			...
			m_tmiInsertLink.IsEnabled = m_tfCurrentLink == null;
			// Disable the 'Edit...' item if there is no hyperlink or 
			// document linkat the current input position.
			m_tmiEditLink.IsEnabled = m_tfCurrentLink != null && (m_tfCurrentLink is TXTextControl.HypertextLink || m_tfCurrentLink is TXTextControl.DocumentLink);
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void OpenCustomLinkDialog_Click(object sender, RoutedEventArgs e) {
			// Open the custom link dialog to create or edit a link.
			LinkDialog dlgLinkDialog = new LinkDialog(m_tfCurrentLink, m_txTextControl);
			dlgLinkDialog.Owner = this;
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void TextControl_TextFieldCreated(object sender, TXTextControl.TextFieldEventArgs e) {
			...
			if (e.TextField is TXTextControl.HypertextLink || e.TextField is TXTextControl.DocumentLink) {
				HighlightLink(e.TextField, m_tmiShowHyperlinks.IsChecked);
			}
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void ShowHyperlinks_Click(object sender, RoutedEventArgs e) {
			...
			foreach (TXTextControl.HypertextLink link in colHyperlinks) {
				HighlightLink(link, m_tmiShowHyperlinks.IsChecked);
			}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void ShowDocumentLinks_Click(object sender, RoutedEventArgs e) {
			...
			foreach (TXTextControl.DocumentLink link in colDocumentLinks) {
				HighlightLink(link, m_tmiShowDocumentLinks.IsChecked);
			}
			m_txTextControl.EndUndoAction();
		}
        ...
        **-----------------------------------------------------------------------------------------------------------*/
		private void DocumentTargets_DropDownOpening(object sender, RoutedEventArgs e) {
			m_dtCurrentDocumentTarget = m_txTextControl.DocumentTargets.GetItem();
			m_tmiEditDocumentTarget.IsEnabled = m_dtCurrentDocumentTarget != null;
			m_tmiShowDocumentTargets.IsChecked = m_txTextControl.DocumentTargetMarkers;
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void InsertDocumentTarget_Click(object sender, RoutedEventArgs e) {
			DocumentTargetDialog dlgDocumentTargetDialog = new DocumentTargetDialog(null, m_txTextControl);
			dlgDocumentTargetDialog.Owner = this;
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void EditDocumentTarget_Click(object sender, RoutedEventArgs e) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void DeleteAndGoToTarget_Click(object sender, RoutedEventArgs e) {
			DeleteAndGoToTargetDialog dlgDeleteAndGoToTargetDialog = new DeleteAndGoToTargetDialog(m_txTextControl);
			dlgDeleteAndGoToTargetDialog.Owner = this;
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void ShowDocumentTargets_Click(object sender, RoutedEventArgs e) {
			m_txTextControl.DocumentTargetMarkers = m_tmiShowDocumentTargets.IsChecked;
		}
